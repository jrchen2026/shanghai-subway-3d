...
- **移动端适配**：竖屏布局、候选面板防 iOS 聚焦缩放、手机端列车动画静态化、系统字体缩放兼容
- **拼音模糊搜索**：站名支持拼音首字母/全拼查找（如 "gjh" 匹配"国家会展中心"），不用切中文输入法逐字找
- **路径分享**：查询结果可复制成短链接（对方打开自动展示同一路径），或生成一张可长按保存/转发的路线图片，专为微信分享场景设计
